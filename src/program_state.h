...
public:
	...
	void put_back_state(point_cloud &pcs, constructed_set &picked, constructed_set &previous_picked, std::vector<constructed_set> &group_informations_, cgv::media::color<float, cgv::media::RGB, cgv::media::OPACITY> &old_color, cgv::media::color<float, cgv::media::RGB, cgv::media::OPACITY> &even_older_color_);
};
